...
## 0. 서비스 구조 개편 (2-Track Strategy) [신규]

### 0.1 기획 및 설계
- [x] `docs/SERVICE_STRUCTURE.md` 작성: 메뉴 구조 및 컨셉 정의
- [ ] 프론트엔드 라우팅 설계 (`/core/*` vs `/future/*`)

### 0.2 프론트엔드 구현
- [ ] **GNB (Global Navigation Bar) 재설계**
  - [ ] 트랙 전환 스위치 (Core Skills ↔ Future Lab) 구현
  - [ ] 트랙별 테마(컬러셋) 분리 적용
- [ ] **Core Skills (Track A) 구성**
  - [ ] 기존 메뉴(`Problems`, `Practice`, `Leaderboard`)를 Core 카테고리로 이동
- [ ] **Future Lab (Track B) 구성**
  - [ ] Future Lab 대시보드(진입점) 페이지 신설
  - [ ] RCA, AI 기능을 Future Lab 메뉴로 배치
